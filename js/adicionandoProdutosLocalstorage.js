...
preco: 'R$ 300,00',
descrição: 'Porque Deus tanto amou o mundo que deu o seu Filho Unigênito, para que todo o que nele crer não pereça, mas tenha a vida eterna.', 
codigo: '#111111'},
            ...
            if (produto.categoria == sectionValor){
                ul.innerHTML += `
                    <li class="produtoAnuncio">
                        ...
                        <a href="" class="produtoLinkAnuncio">Ver produto</a>
                    </li>
                    ` 
            }
	});
...
function BtnVerProduto(){
    btnVerProdutoVar = document.querySelectorAll(".produtoLinkAnuncio");

    btnVerProdutoVar.forEach(produto =>{
       produto.addEventListener('click', (e) =>{
        e.preventDefault();
        var produtoNome = {nome: e.path[1].children[1].textContent}
